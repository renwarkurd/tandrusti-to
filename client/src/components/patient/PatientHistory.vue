<template>
  <div class="border-1 rounded-lg p-3 shadow-sm">
    <div class="text-center font-bold text-lg pb-4 border-0 text-sm-green">مێژووی تەندرووستی</div>

    <div class="row">
      <div class="col-12 col-sm-6">
        <div class="table-responsive border-1 rounded">
          <table class="table">
            <tbody>
              <tr>
                <td
